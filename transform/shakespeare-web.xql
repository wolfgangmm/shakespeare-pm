(:~
    ...
    ODD: /db/apps/shakespeare-pm/resources/odd/compiled/shakespeare.odd
 :)
xquery version "3.1";

module namespace model="http://www.tei-c.org/tei-simple/models/shakespeare.odd/web";
    ...
    $input !         (
            typeswitch(.)
                ...
                case element(pb) return
                    (
                        html:graphic($config, ., ("tei-pb1", "facs"), ., "../data/facs/" || substring-after(@facs, "FFimg:"), "100%", (), (), ())
                    )
